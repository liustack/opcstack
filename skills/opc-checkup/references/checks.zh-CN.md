...
这两个是从 liustack 的 deep-thought 格栅搬来的。它们原本挂在策略层，一直不合身：**它们分析的是生意，不是判断。**商业体检才是它们该干活的地方。

### 杠杆：一份投入能撬动多少

一人公司没法加人，产出要涨，唯一的路是每一份投入比过去撬得更多。四种，其中只有三种算杠杆。

- **代码。** 写一次就在你睡觉时继续工作的软件。每多一个用户的边际成本是零。
- **媒体。** 发一次就在持续把人带进来的内容。同样的性质。
- **资本。** 用钱直接买到一个结果，而你本来要花几个月去造它。
- **人力，它不是杠杆。** 你自己的工时，以及任何按小时雇来的人。产出跟投入线性增长，你一停它就停。

**要检查的是：这门生意实际靠前三种里的哪一种在撑。**如果诚实的答案是「靠我的工时」，那它没有杠杆，所有建立在它之上的增长计划都是「多干活」计划。这是一人公司最常见的失败形状，而且从营收那一行完全看不出来——数字可以一直好看到人停下来的那一刻。

值得读：《纳瓦尔宝典》。

### 关键少数：结果集中在哪

粗略地说，大部分结果来自一小部分投入，比例很少有 80/20 那么整齐。**要紧的不是那个数字，是这个问题：到底有没有人真去查过是哪一部分？**

按顺序查：

1. 把收入按功能、按客户、按渠道拆开。不是按各自花了多少工夫拆，是按各自带回了什么拆。
2. 找到集中的地方。多数一人产品有一个功能在扛着付费客户，而它经常不是创始人自己最感兴趣的那个。
3. 拿它对照最近三个月的工时去了哪。

**这两者之间的落差就是结论。**常见的形状是：八成时间花在只带来两成价值的功能上，而客户真正付钱买的那个，自发布之后就没再动过。

反过来要当心：那一小部分之所以能扛，往往是因为其余部分存在。**把另外八成整片砍掉，是一个产品变得没法用、而指标看上去还很集中的经典死法。**
