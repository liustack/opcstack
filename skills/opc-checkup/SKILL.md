...
七步即元认知调用栈的商业化：1–2 净化认知，3–5 优化决策，6 防火墙复核，7 设计行动与验证。
...
体检报告：现金流 Razor 判语 / 三表逐节结论（红黄绿标注）/ 寿命分型与对应风控 / 单元经济判定 / SPOF 清单 / **结论四态：继续（套利型附退出纪律，复利型附资产沉淀计划）、调整后继续（列明改什么）、转向（能力圈资产带去哪）、停止（止损与可带走清单）** / 防火墙自检记录（哪条差点骗过你）/ 最小验证计划 / **补课书方**——针对体检暴露的最薄弱的一两个要素，从 `references/checks.md` 补课书单对应节各开 1–2 本，并说明为什么是这几本。不开全书单，只补最短的板。
