...
- 《商业模式新生代》（Business Model Generation）——画清收益与成本结构。
- 《价值主张设计》（Value Proposition Design）——价值主张与愿付价格。
...
**关键词：** 生态位（Niche）/产业链位置（生态控制权）/ 波特五力模型 / 交易成本·科斯企业边界 / 委托—代理问题 / 网络效应（直接/间接）/ 双边·多边平台 / 平台规则与抽成 / 订阅制/SaaS / 渠道结构·分销·BD / 流量漏斗 AARRR / 博弈论·策略互动 / 资本配置（Capital Allocation）/ 交易结构设计 / 7 Powers（七种力量）/ 双边·多边平台
...
- 《周期》（霍华德·马克斯）——识别繁荣与萧条。
- 《商界局外人》——顶级资本配置与复利决策。
- 《雪球：巴菲特和他的财富人生》或《巴菲特致股东的信》——复利与时间朋友。
- 《增长黑客》（Hacking Growth）——数据驱动的飞轮与迭代。
- 《穷查理宝典》——理解复利与多学科思维。
- 《创新者的窘境》——理解技术演进周期。
...
- 《随机漫步的傻瓜》——识别运气与噪音。
- 《精益创业》（The Lean Startup）——小赌验证，大错之前止损。
- 《纳瓦尔宝典》——杠杆、可选性与"玩长局"。
- 《非对称风险》（塔勒布）——理解利益攸关（Skin in the Game）。
